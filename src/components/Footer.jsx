...
const footerLinks = {
  Programs: [
    { to: '/warrior-culture', label: 'Warrior Culture Sessions' },
    { to: '/individual-camps', label: 'Individual Camps' },
    { to: '/mindset-training', label: 'Mindset Training' },
    { to: '/be-grundy-foundation', label: 'Be Grundy Foundation' },
  ],
  Company: [
      ...
      <div className="footer-bottom">
        <div className="container">
          <p className="footer-copy">
            &copy; {new Date().getFullYear()} One Heartbeat Warriors. All rights reserved.
          </p>
